...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM appointment WHERE IDappoint = $id";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <p>Êtes-vous sûr de vouloir supprimer cette fiche de appointment?</p>
                            <p>
                                <input type="submit" value="Oui" class="btn btn-danger">
                                <a href="/gestion%20dentaire/RendezVous/RendezVous.php" class="btn btn-secondary">Non</a>
                            </p>
                        </div>
                    </form>
                </div>
