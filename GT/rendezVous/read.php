            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                            ...
                            <p><b><?php echo $row["dateAppoint"]; ?></b></p>
                       </div>
                       <div class="form-group">
                            <label>patient</label>
                            <p><b><?php echo $row["patient"]; ?></b></p>
                       </div>
                       <div class="form-group">
                            <label>TimeAppoint</label>
                            <p><b><?php echo $row["TimeAppoint"]; ?></b></p>
                       </div>
                    <div class="form-group">
                            <label>Traitement</label>
                            <p><b><?php echo $row["Traitement"]; ?></b></p>
                       </div>
                  
                    <p><a href="/gestion%20dentaire/RendezVous/RendezVous.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
